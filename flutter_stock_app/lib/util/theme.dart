...
class MaterialTheme {
  ...
  static const customColor1 = ExtendedColor(
    seed: Color(0xff006b76),
    value: Color(0xff006b76),
    light: ColorFamily(
      color: Color(0xff006973),
      onColor: Color(0xffffffff),
      colorContainer: Color(0xff9eeffc),
      onColorContainer: Color(0xff004f57),
    ),
    ...
    dark: ColorFamily(
      color: Color(0xff81d3e0),
      onColor: Color(0xff00363c),
      colorContainer: Color(0xff004f57),
      onColorContainer: Color(0xff9eeffc),
    ),
