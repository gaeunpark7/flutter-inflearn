...
mixin _$Note {
 ...
 String get title; String get content; int get color; int get timestamp; int? get id;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,title,content,color,timestamp,id);
...
@useResult
$Res call({
 String title, String content, int color, int timestamp, int? id
});
...
/// Create a copy of Note
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? title = null,Object? content = null,Object? color = null,Object? timestamp = null,Object? id = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String title,  String content,  int color,  int timestamp,  int? id)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Note() when $default != null:
return $default(_that.title,_that.content,_that.color,_that.timestamp,_that.id);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String title,  String content,  int color,  int timestamp,  int? id)  $default,) {final _that = this;
switch (_that) {
case _Note():
return $default(_that.title,_that.content,_that.color,_that.timestamp,_that.id);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String title,  String content,  int color,  int timestamp,  int? id)?  $default,) {final _that = this;
switch (_that) {
case _Note() when $default != null:
return $default(_that.title,_that.content,_that.color,_that.timestamp,_that.id);case _:
  return null;
...
class _Note implements Note {
   _Note({required this.title, required this.content, required this.color, required this.timestamp, this.id});
...
/// Create a copy of Note
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? title = null,Object? content = null,Object? color = null,Object? timestamp = null,Object? id = freezed,}) {
  return _then(_Note(
title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
as String,content: null == content ? _self.content : content // ignore: cast_nullable_to_non_nullable
as String,color: null == color ? _self.color : color // ignore: cast_nullable_to_non_nullable
